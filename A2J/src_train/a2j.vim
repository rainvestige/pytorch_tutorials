...
map  tdc g:table_mode_delete_column_map
...
set laststatus=2
set pyxversion=3
set runtimepath=~/.vim,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-colors-solarized,~/.vim/plugged/YouCompleteMe,~/.vim/plugged/ale,~/.vim/plugged/markdown-preview.nvim,~/.vim/plugged/vimwiki,~/.vim/plugged/nerdtree,~/.vim/plugged/nerdtree-git-plugin,~/.vim/plugged/vim-json,~/.vim/plugged/vim-css3-syntax,~/.vim/plugged/vim-coloresque,~/.vim/plugged/vim-javascript,~/.vim/plugged/emmet-vim,~/.vim/plugged/vimtex,~/.vim/plugged/ultisnips,~/.vim/plugged/supertab,/usr/local/vim8/share/vim/vimfiles,/usr/local/vim8/share/vim/vim82,/usr/local/vim8/share/vim/vimfiles/after,~/.vim/plugged/vim-css3-syntax/after,~/.vim/plugged/vim-coloresque/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/vimtex/after,~/.vim/plugged/ultisnips/after,~/.vim/after
set shiftwidth=4
...
argglobal
%argdel
$argadd ~/projects/A2J/src/icvl.py
set stal=2
tabnew
tabnew
tabrewind
edit ~/projects/A2J/src_train/nyu.py
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 100 + 102) / 205)
...
351
normal! zo
let s:l = 121 - ((47 * winheight(0) + 25) / 50)
...
wincmd w
argglobal
if bufexists("~/projects/A2J/src/icvl.py") | buffer ~/projects/A2J/src/icvl.py | else | edit ~/projects/A2J/src/icvl.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 104 + 102) / 205)
tabnext
edit ~/projects/A2J/src/model.py
set splitbelow splitright
set nosplitbelow
wincmd t
set winminheight=0
...
180
normal! zo
let s:l = 186 - ((49 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
normal! 032|
tabnext
edit ~/projects/A2J/data/icvl/data_preprosess.m
set splitbelow splitright
set nosplitbelow
wincmd t
set winminheight=0
...
tabnext 1
set stal=1
badd +121 ~/projects/A2J/src_train/nyu.py
badd +3 ~/projects/A2J/src/icvl.py
badd +1 ~/projects/A2J/src/model.py
badd +12 ~/projects/A2J/data/icvl/data_preprosess.m
badd +82 ~/projects/A2J/src/anchor.py
